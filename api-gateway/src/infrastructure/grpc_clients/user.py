...
from src.schemas.api.user import UpdateUserDataSchema, UserData, UserIdSchema
...
class RpcUserService:
    ...
    async def create_user(self, username: str, password: str):
        request = user_pb2.CreateUserRequest(username=username, password=password)
    ...
    async def update_user(self, id: int, data: UpdateUserDataSchema):
        request = user_pb2.UpdateUserRequest(id=id, **data.model_dump())
