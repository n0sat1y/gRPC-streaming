...
class MessageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ForwardMessage = channel.unary_unary(
            "/message.MessageService/ForwardMessage",
            request_serializer=message__pb2.ForwardMessageRequest.SerializeToString,
            response_deserializer=message__pb2.ForwardMessageResponse.FromString,
            _registered_method=True,
        )
...
def add_MessageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "ForwardMessage": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=message__pb2.ForwardMessageRequest.FromString,
            response_serializer=message__pb2.ForwardMessageResponse.SerializeToString,
        ),
    }
...
class MessageService(object):
    ...
    def ForwardMessage(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/message.MessageService/ForwardMessage",
            message__pb2.ForwardMessageRequest.SerializeToString,
            message__pb2.ForwardMessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
